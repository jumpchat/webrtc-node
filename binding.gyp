    ...
    'targets': [
        {
            ...
            "sources": [
                ...
                "src/RTCPeerConnection.cpp",
                "src/RTCPeerConnectionObservers.cpp",
                "src/RTCRtpReceiver.cpp",
                "src/RTCRtpSender.cpp",
                "src/RTCRtpTransceiver.cpp",
                "src/RTCStatsReport.cpp",
                "src/RTCStatsResponse.cpp",
